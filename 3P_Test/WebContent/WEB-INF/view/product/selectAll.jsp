...
<!-- 0123 현희 남자 향수 시작 -->
                            <div class="category-header">
                                <h1>MEN</h1>
                                <ol class="breadcrumb" id="menMore">
                                	<li class="active">검색어</li>
                                    <li><a href="#"><span style="color : #ff0066;">남자</span> 향수 더 보기</a></li>
                                </ol>
                            </div>
...
<!-- 0123 현희 여자 향수 시작 -->
                        <div class="col-md-9 col-md-push-3">
                            <div class="category-header">
                                <h1 style="color : #ff0066;">WOMEN</h1>
                                <ol class="breadcrumb" id="womenMore">
                                	<li class="active">검색어</li>
                                    <li><a href="#"><span style="color : #ff0066;">여자</span> 향수 더 보기</a></li>
                                </ol>
                            </div>
